...
(function ($) {
  $(document).ready(function ($) {
    var buttonSelector = ".ama-bp-accordion-button";
     ...
     */
    $(".paragraph--ama-bp-accordion-container").each(function () {
     ...
     */
    $(".paragraph--type--ama-bp-accordion").on('shown.bs.collapse', function () {
     ...
     */
    $(".paragraph--type--ama-bp-accordion").on('hidden.bs.collapse', function () {
